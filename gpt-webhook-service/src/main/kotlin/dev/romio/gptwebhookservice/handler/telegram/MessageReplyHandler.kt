...
class MessageReplyHandler private constructor(
    ...
    class Builder private constructor() {
        ...
        fun build(): MessageReplyHandler {
            if(conversationHandler == null || tgBot == null) {
                throw IllegalArgumentException("All must required arguments are not provided for " +
            ...
            return flow {
                ...
                when(val response = conversationHandler.getResponseMessage(userMessage)) {
                    ...
                    is Either.Left -> {
                        ...
                        emit(TelegramResponseTextMessage(
                            telegramMessage.chatId,
    ...
    private suspend fun handleResponse(
        receivedMessage: TelegramReceivedMessage,
        chatId: Long,
        responseText: String,
        ...
        if(responseText.contains("command-text:")) {
            ...
            flowCollector.emit(TelegramResponseTextMessage(
                chatId,
                responseText
            ))
        }
